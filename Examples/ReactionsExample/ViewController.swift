  ...
  @IBOutlet weak var facebookReactionButton: ReactionButton! {
    didSet {
      ...
      facebookReactionButton.config           = ReactionButtonConfig() {
        ...
        $0.neutralTintColor = k_kinkyMagentaColor//UIColor(red: 0.47, green: 0.47, blue: 0.47, alpha: 1)
        $0.alignment        = .left
      }
  ...
  @IBOutlet weak var reactionSummary: ReactionSummary! {
    didSet {
      ...
      reactionSummary.config    = ReactionSummaryConfig {
        ...
        $0.textColor    = k_kinkyMagentaColor//UIColor(red: 0.47, green: 0.47, blue: 0.47, alpha: 1)
        $0.alignment    = .left
        $0.isAggregated = true
      }
    }
